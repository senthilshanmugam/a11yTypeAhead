a11yModule.directive('a11yCityTypeAhead', ['$timeout', '$sce', '$compile', 'a11yCommon', function ($timeout, $sce, $compile, a11yCommon) {
    return {
        restrict: 'E',
        replace: true,
        transclude: true,
        ...
        templateUrl: 'Components/a11yCityTypeAhead/a11yCityTypeAhead.html',
