...
datepicker.prototype.popGrid = function () {
    ...
    for (curDay = 1; curDay <= numDays; curDay++) {
        if (curDay == this.date && this.currentDate == true) {
            ...
            rowCount + ' ' + this.dayNames[weekday] + '" role="gridcell" ariaselected="false">' + curDay + '</td>';
        }
        else {
...
datepicker.prototype.handleGridKeyDown = function (e) {
    ...
    switch (e.keyCode) {
        ...
        case this.keys.space: {
            ...
            this.$target.val((this.month < 9 ? '0' : '') + (this.month + 1) + '/' + $curDay.html() + '/' +
            this.year);
            // fall through
        }
        case this.keys.esc: {
...
datepicker.prototype.handleGridBlur = function (e) {
    $('#' + this.$grid.attr('aria-activedescendant')).removeClass('focus').attr('aria-selected',
    'false');
    return true;
} // end handleGridBlur()
//
